...
const MostrarProductosAdmin = (nombre, precio, descripcion, imagen, id, categoria) => {
  ...
  <div class="producto__card__imagen" style="background-Image: url(${imagen})">
        <a class="boton-eliminar" id="${id}" href="#"><img src="../assets/img/icons/delete.svg" alt="boton eliminar"></a>
        <a class="boton-editar" href="../screens/editar-producto.html?id=${id}"><img src="../assets/img/icons/edit.svg" alt="boton editar"></a>
  </div>
  ...
  btnEliminar.addEventListener("click", () => {
    ...
    Swal.fire({
      title: 'Estas seguro?',
      text: `Quieres eliminar el producto: ${nombre} ? esta accion no sera revertible!`,
      icon: 'question',
      ...
      if (result.isConfirmed) {
        clienteServices.eliminarProducto(id).then(respuesta => {
